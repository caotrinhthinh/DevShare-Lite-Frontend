        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-600 mb-6 leading-relaxed">
              Empowering developers to share knowledge, learn together, and
            ...
            <div className="flex space-x-4">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="p-2 text-gray-400 hover:text-primary-600 transition-colors duration-200 rounded-lg hover:bg-gray-50"
        ...
        <div className="border-t border-gray-200 pt-8">
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="flex items-center space-x-4 text-sm text-gray-600 mb-4 md:mb-0">
              <p>&copy; {currentYear} DevShare Lite. All rights reserved.</p>
              <span className="hidden md:inline">•</span>
              <p className="hidden md:inline">Made with ❤️ for developers</p>
            </div>
